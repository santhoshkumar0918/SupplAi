    ...
    return (
      <DashboardWrapper>
        <div className="flex flex-col items-center justify-center h-64">
          ...
          <p className="mt-4 text-blue-400 font-medium">AI Agents Processing Data...</p>
        </div>
      </DashboardWrapper>
    );
  }
          ...
          <CardContent className="p-3">
            <div className="flex items-center">
              ...
              <p className="text-sm text-blue-300">
                <span className="font-semibold">AI Agents Active:</span> All systems operational. Processing {batches.length} batches with {healthMetrics?.successful_transactions || 0} verified blockchain transactions.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <Card className="bg-gray-800/50 border-gray-700 backdrop-blur-sm shadow-lg overflow-hidden">
            ...
            <CardContent>
              <div className="flex flex-col">
                ...
                <p className="text-gray-400 text-sm mb-3">Total Monitored Batches</p>

                <div className="w-full mt-2 grid grid-cols-2 gap-4">
                  <div className="flex flex-col">
                    <div className="text-xl font-semibold text-blue-400">
                      {batches.filter((b) => b.batch_status === "InTransit").length}
                    </div>
                  ...
                  <div className="flex flex-col">
                    <div className="text-xl font-semibold text-green-400">
                      {batches.filter((b) => b.batch_status === "Delivered").length}
                    </div>
                    <div className="flex items-center text-xs text-gray-400">
          ...
          <Card className="bg-gray-800/50 border-gray-700 backdrop-blur-sm shadow-lg overflow-hidden">
            ...
            <CardContent>
              <div className="flex flex-col">
                ...
                <p className="text-gray-400 text-sm mb-3">Ledger Transactions</p>
